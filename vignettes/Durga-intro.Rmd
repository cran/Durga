...
The Durga implementation of Cohen's d uses pooled standard deviation, so what if you need to Cohen's d with averaged standard deviations instead? The following example shows one way to use the `cohens_d` function from the [effectsize](https://easystats.github.io/effectsize/index.html) R package with Durga.
